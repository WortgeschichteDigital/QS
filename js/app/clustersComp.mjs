...
export { clustersComp as default };
...
const clustersComp = {
  ...
  build () {
    // prepare section
    const cont = document.getElementById("clusters-compare");
    ...
    if (!Object.keys(similar).length) {
      cont.appendChild(misc.nothingToShow("Keine einander ähnlichen Cluster!", "Tipp: Ändern sie die Filtereinstellungen."));
      return;
    }
